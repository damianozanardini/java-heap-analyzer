...
public class BDDDomainsExample {
	...
	public static void main(String[] args) {
        ...
        // TODO mejor desplazar bits
        //long bitOffsetR = (long) Math.pow(2, nbits);
        long bitOffsetR = 1 << nbits;

        BDDDomain registers = bdd.extDomain(bitOffsetR*bitOffsetR);
        BDD reg5l = registers.ithVar(6);
        System.out.println("reg5l: " + reg5l);

        System.out.println(bitOffsetR);
        BDD reg5r = registers.ithVar(6*bitOffsetR);
        System.out.println("reg5r: " + reg5r);
        
        BDD regX = registers.ithVar(6+6*bitOffsetR);
