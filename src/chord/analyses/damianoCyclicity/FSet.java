...
public class FSet {
	 ...
	 */
	public FSet(jq_Field fld) {
		DomAbsF fields = (DomAbsF) ClassicProject.g().getTrgt("AbsF");
	...
	public static FSet emptyset() {
		DomFSet fieldsets = (DomFSet) ClassicProject.g().getTrgt("FSet");
	 ...
	 */
	public static FSet union(FSet fs1, FSet fs2) {
		DomFSet fieldsets = (DomFSet) ClassicProject.g().getTrgt("FSet");
	 ...
	 * @return The union of both field sets.
	 */
	public static FSet addField(FSet fs, jq_Field fld) {
		DomAbsF fields = (DomAbsF) ClassicProject.g().getTrgt("AbsF");
		DomFSet fieldsets = (DomFSet) ClassicProject.g().getTrgt("FSet");
		int id = fields.indexOf(fld);
		if (id >= 0) { // the field is tracked explicitly
	 ...
	 */
	public static FSet removeField(FSet fs, jq_Field fld) {
		DomAbsF fields = (DomAbsF) ClassicProject.g().getTrgt("AbsF");
		DomFSet fieldsets = (DomFSet) ClassicProject.g().getTrgt("FSet");
		int id = fields.indexOf(fld);
		if (id >= 0) { // the field is tracked explicitly
	 ...
	 * equal to fs2's
	 */
	public static boolean leq(FSet fs1, FSet fs2) {
