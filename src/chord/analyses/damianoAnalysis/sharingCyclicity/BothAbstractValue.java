 ...
 * Decision Diagrams) implementation.  A {@code BothAbstractValue} object contains
 * a {@code TuplesAbstractValue} and a {@code BDDAbstractValue}
...
public class BothAbstractValue extends AbstractValue {
	...
	/**
	 * Returns the {@code TuplesAbstractValue} object.
	 * 
	 * @return
	 */
	...
	/**
	 * The {@code BDDAbstractValue} object
	 */
	private BDDAbstractValue bddAV;

	/**
	 * Returns the {@code BDDAbstractValue} object.
	 * 
	 * @return
	 */
	 ...
	 * (2) in general, a {@code BothAbstractValue} object is guaranteed to have
	...
	/**
	 * Returns a new {@code BothAbstractValue} object with the same abstract
	 * information.
	 * 
